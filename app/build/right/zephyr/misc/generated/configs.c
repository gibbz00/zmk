...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHIELD_BORNE_RIGHT, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_BORNE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_ENABLE_DCDC, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_BORNE_CHARGER_CURRENT_100MA, 1);
